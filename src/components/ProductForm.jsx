 ...
 * 
 * Props:
 * - onSubmit: función callback que recibe los datos del producto
 * - apiType: tipo de API utilizada (para mostrar en el título)
 */
  ...
  <form onSubmit={handleSubmit} className="product-form">
    ...
    <div className="form-group">
      ...
      <small className="form-help">
        Puede subir la imagen a Supabase Storage o usar un servicio como Imgur
      </small>
    </div>
